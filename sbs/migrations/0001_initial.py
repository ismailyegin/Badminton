...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('compType', models.IntegerField(blank=True, choices=[(0, 'Üniversiteler Arası'), (1, 'Okullar Arası'), (2, 'Ferdi'), (3, 'Grand Prix')], db_column='compType', null=True)),
                ('creationDate', models.DateTimeField(auto_now_add=True, db_column='creationDate', null=True)),
                ('finishDate', models.DateTimeField(blank=True, db_column='finishDate', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloodType', models.CharField(blank=True, choices=[('AB Rh+', 'AB Rh+'), ('AB Rh-', 'AB Rh-'), ('A Rh+', 'A Rh+'), ('A Rh-', 'A Rh-'), ('B Rh+', 'B Rh+'), ('B Rh-', 'B Rh-'), ('0 Rh+', '0 Rh+'), ('0 Rh-', '0 Rh-')], max_length=128, null=True, verbose_name='Kan Grubu')),
                ('gender', models.IntegerField(choices=[(0, 'Erkek'), (1, 'Kadın')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(blank=True, choices=[('RAKET', 'RAKET'), ('TOPLAR', 'TOPLAR'), ('AYAKKABI', 'AYAKKABI'), ('ÇANTA', 'ÇANTA'), ('AKSESUAR', 'AKSESUAR'), ('GRİP', 'GRİP'), ('KORDAJ', 'KORDAJ'), ('EKİPMAN', 'EKİPMAN'), ('KIYAFET', 'KIYAFET')], max_length=128, null=True, verbose_name='category')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('coach', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='sbs.Coach')),
        ...
        migrations.AddField(
            ...
            name='country',
            field=models.ForeignKey(db_column='country', on_delete=django.db.models.deletion.CASCADE, to='sbs.Country', verbose_name='Ülke'),
        ),
        migrations.AddField(
            model_name='coach',
            name='communication',
