# Generated by Django 2.2.6 on 2020-08-18 13:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.CharField(blank=True, choices=[('HALTER', 'HALTER')], max_length=128, null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastsilkliftvalue',
                 models.IntegerField(blank=True, db_column='lastSilkLiftValue', default=0, null=True)),
            ],
            options={
            ...
            fields=[
                ...
                ('bloodType', models.CharField(blank=True,
                                               choices=[('AB Rh+', 'AB Rh+'), ('AB Rh-', 'AB Rh-'), ('A Rh+', 'A Rh+'),
                                                        ...
                                                        ('0 Rh+', '0 Rh+'), ('0 Rh-', '0 Rh-')], max_length=128,
            ...
            fields=[
                ...
                ('cityHeadShip',
                 models.ForeignKey(db_column='cityHeadShip', on_delete=django.db.models.deletion.CASCADE,
                                   to='sbs.City')),
                ('coach', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                            to='sbs.Coach')),
