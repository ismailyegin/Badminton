...
class Competition(models.Model):
    ...
    eventDate = models.CharField(db_column='eventDate', max_length=45, blank=True,
                                 null=True)  # Field name made lowercase.
    juryCount = models.IntegerField(db_column='juryCount', blank=True, null=True)  # Field name made lowercase.
    compGeneralType = models.IntegerField(db_column='compGeneralType', blank=True, null=True,
                                          choices=COMPGENERALTYPE)  # Field name made lowercase.
